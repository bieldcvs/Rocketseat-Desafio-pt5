...
export class Favorites{
  ...
  load(){
    ...
    if (this.entries == undefined ){
      document.querySelector('.pag').classList.add('hide')
    }
  }
...
//classe que vai criar a visualização a eventos do HTML
...
export class FavoritesView extends Favorites {
  ...
  <tr>
          <td class="user">
            <img src="https://github.com/diego3g.png" alt="Imagem de Gabriel">
